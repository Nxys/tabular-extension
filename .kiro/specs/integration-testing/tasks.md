...
- [ ] 2.2 扩展 TestPages - 大型表格页面
  - 添加 generateLargeTablePage() 函数
  - 支持指定行数和列数
  - 生成包含测试数据的表格
  - _需求：9.2_

- [ ] 2.3 扩展 TestPages - 边界情况页面
