 ...
 * - 可被单元测试导入
 * 
 * 注意：此文件导出函数供测试使用，不会影响 Chrome 插件加载
 */

import type { RequestActionMessage, ActionResultMessage, AdvancedFeature, ExportFormat } from '../shared/types';
